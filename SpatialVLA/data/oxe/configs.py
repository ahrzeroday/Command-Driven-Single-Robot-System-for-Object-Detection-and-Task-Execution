...
OXE_DATASET_CONFIGS = {
    "my_robot_dataset/1.0.0": {
    "image_obs_keys": {"primary": "image"},
    "depth_obs_keys": {},
    "state_obs_keys": ["proprio"],
    "state_encoding": StateEncoding.POS_EULER, # 3-pos, 3-euler, 1-pad (که ما استفاده نمی‌کنیم)
    "action_encoding": ActionEncoding.EEF_POS, # 7-DoF (دلتا موقعیت، دلتا چرخش، گریپر)
},
